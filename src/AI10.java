...
/**
 * Variable Positional AI - weights squares in both directions
 *
 * Picks moves based on position scores and reweights squares around corners it takes
 * This looks in both directions around corners for weighting squares
 */
public class AI10 extends AI {
    ...
    public AI10(GamePiece colour, boolean gui) {

        super(colour, gui);
        playerType = PlayerType.AI;
        name = "Variable Positional - weights squares in both directions";
    }
